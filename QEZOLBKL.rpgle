...
/// @refers QEZOLBKL(backupType): Return information for objects that are backed up *DAILY.
dcl-c BACKUP_DAILY '*DAILY';
/// @refers QEZOLBKL(backupType): Return information for objects that are backed up *WEEKLY.
dcl-c BACKUP_WEEKLY '*WEEKLY';
/// @refers QEZOLBKL(backupType): Return information for objects that are backed up *MONTHLY.
...
/// @parameter The name of the format to be used to return the requested information. See XXXXX
